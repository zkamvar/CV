...
\title{ } % \title{Resum\'{e}}
\address{School of Public Health}{Imperial College London W2 1NY, UK}
\mobile{+44 7444 840264}
% \phone{(541) 738-4074}
\extrainfo{Twitter: \href{https://twitter.com/zkamvar}{@zkamvar}}
\email{xxxxxxxxxx@gmail.com}
\homepage{https://zkamvar.netlify.com}{https://zkamvar.netlify.com} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\input{./tex/Cover/2019-10X-test.tex}
