...
\cventry{Main Author:}{}{}{}{}{
	\begin{itemize}
		\item poppr: R package for analysis of populations with mixed reproductive modes.
	\end{itemize}
}

\cventry{Contributer:}{}{}{}{}{
	\begin{itemize}
		\item adegenet: R package for multivariate analysis of population genetics.
		\item phytophthora-id: Web application for identification of clonal lineages of two \textit{Phytophthora} species.
	\end{itemize}
}
...
\begin{enumerate}[leftmargin = 14pt]
	...
	\item Weiland JE, Garrido PA, \textbf{Kamvar ZN}, Marek SM, Grünwald NJ, and
	Garzón CD. Population structure of \textit{Pythium irregulare}, \textit{P.
	sylvaticum}, and \textit{P. ultimum} in forest nursery soils of Oregon and
	Washington. \textit{Phytopathology}. In \textbf{press}.
