...
% Preventing
% problems of methodical ambiguity can only be done with a strong collaboration
% between scientists, statisticians, and software developers. I have direct
% experience in managing projects with contributors with varying skill sets and
% am eager to work together to bring better tools, standards, and training for
% statistical software development and use. 
