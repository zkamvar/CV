...
\cvitem{}{Version Control (git), Continuous Integration (Travis CI, Appveyor, Circle CI), Unit Testing, Memory Profiling}
...
\cvitem{Competent}{\textsc{C}, \textsc{Make}, \LaTeX, \textsc{bash}, \textsc{python}, \textsc{perl}}
