...
\cventry{2020--2023}{Lesson Infrastructure Developer}{The Carpentries}{}{}{
  ...
  $\bullet$ Skills Acquired: \textbf{AWS, Operational Excellece, Security, Monitoring Frameworks}
}
...
\cventry{2012--2016}{Graduate Research Assistant}{Oregon State University}{}{Ph. D. Dissertation Research}{
...
\cvitem{$\bullet$}{\textbf{\textgreater5 years} of \textbf{leadership experience} coordinating software development for a \textbf{broad set of stakeholders} in Population Genetics, Epidemiology, and Computer Science Education}
...
\cvitem{$\bullet$}{Developed GitHub Actions to work with the GitHub (REST and GraphQL) API using \textbf{BASH, R, and node JS} (\textbf{3 years})}
...
\cvitem{\hfill Management}{\hrule}
\cvitem{$\bullet$}{Developed a modular, \textbf{user-friendly and accessible} open source lesson infrastructure to facilitate \textbf{automated validation, rendering, and system monitoring} of data science lessons that are maintained by \textbf{\textgreater100 volunteers} serving \textbf{\textgreater10,000 learners annually}}
