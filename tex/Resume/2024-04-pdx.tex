...
\cventry{2020--2023}{Lesson Infrastructure Developer}{The Carpentries}{}{}{
  Lead development and deployment of a modular infrastructure for building reproducible lessons for a broad community of educators to bring data science skills to thousands of researchers worldwide.
}
...
\cvitem{DevOps \dotfill\phantom{$\bullet$}}{\hrule}
...
\cvitem{$\bullet$}{Highly experienced \textbf{\textgreater10 years} experience in \textbf{developing and deploying well-tested research software using Git and CI/CD pipelines} (GitHub Actions, Circle CI, Travis CI)}
\cvitem{$\bullet$}{\textbf{\textgreater5 years} of \textbf{leadership experience} coordinating software development for a \textbf{broad set of stakeholders} in the fields of Population Genetics, Epidemiology, and Computer Science Education}
\cvitem{$\bullet$}{\textbf{\textgreater5 years} experience building \textbf{reproducible analyses with CI and Docker} \textit{(Kamvar, 2017)}}
...
\cvitem{Management\hfill\phantom{$\bullet$}}{\hrule}
\cvitem{$\bullet$}{Developed a modular, \textbf{user-friendly and accessible} open source lesson infrastructure to facilitate \textbf{automated validation, rendering, and system monitoring} of data science lessons}
...
\cvitem{$\bullet$}{\textbf{Coordinated communications} to hundereds of stakeholders in separate sub-communities about the impacts of upcoming infrastructure changes via video, blogs, and live Q\&A}
...
\cvitem{Tools \dotfill\phantom{$\bullet$}}{\hrule}
\cvitem{$\bullet$}{\textbf{Expert R developer} of several widely used R packages (\textbf{\textgreater10 years})}
\cvitem{$\bullet$}{Experienced in creating unique \textbf{Python 3} modules for population genomic simulation analysis pipeline (\textbf{3 years})}
% \cvitem{$\bullet$}{Experienced in parsing structured text content in \textbf{XPath} and \textbf{Lua} (\textbf{3 years})}
\cvitem{$\bullet$}{Developed GitHub Actions to work with the GitHub (REST and GraphQL) API using BASH, R, and \textbf{node JS} (\textbf{3 years})}
\cvitem{$\bullet$}{Maintained \textbf{reproducible pipelines in Make and BASH} (\textbf{2 years}) for both continuous integration and HPC frameworks}
...
\cvitem{$\bullet$}{Author of \textbf{>30 technical blog posts}}
...
\cvitemwithcomment{Analyses:}{\href{https://github.com/zkamvar/clonal-inference-simulations}{zkamvar/clonal-inference-simulations}}{\dotfill simulation-based analysis in \textbf{Python}, \textbf{R}, and \textbf{BASH}}
...
\section{Selected Publications}
  ...
  \cvitem{Blog Post}{2023-06-28 | \textit{Updates on The Carpentries Lesson Infrastructure} | The Carpentries Blog |   \url{https://carpentries.org/blog/2023/06/lesson-infrastructure-updates/}}
  ...
  \cvitem{Blog Post}{2022-06-14 | \textit{Communication \& Collaboration with Contributors in an Open-Source Organization} | The ROpenSci Blog | \href{https://doi.org/10.59350/z329k-sqn35}{doi: 10.59350/z329k-sqn35}}
