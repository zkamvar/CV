...
\cvitem{Curriculum:}{\textbf{5 years experience} collaborative \textbf{open source} lesson development targeted for \textbf{interdisciplinary and diverse audiences}}
\cvitem{}{Developed and delivered lessons for \textbf{9 workshops} that reached \textbf{>300 people} in international conferences}
\cvitem{}{Collaboratively developed \textbf{5 tutorial websites} in \textbf{RMarkdown and blogdown} to host \textbf{discoverable lessons for non-technical audiences}}
...
\cvitem{}{Maintained \textbf{reproducible pipelines in Make and BASH} (\textbf{2 years}) for both continuous integration and HPC \textbf{Linux} frameworks}
...
\cvitem{}{\textbf{Co-founder and host (5 years)} of award-winning \textbf{science communication radio program}, Inspriration Dissemination}
...
\cvitemwithcomment{2014}{\href{https://grunwaldlab.github.io/Population_Genetics_in_R}}{R for population genetic analysis}
\cvitemwithcomment{2015}{\href{https://grunwaldlab.github.io/Reproducible_Research_in_R}}{reproducible research for plant pathologists}
\cvitemwithcomment{2016}{\href{https://popgen.nescent.org}}{\textbf{Peer-reviewed community-submitted tutorials} for population genetic analysis in R}
\cvitemwithcomment{2017}{\href{https://everhartlab.github.io/Intro_R}}{Introduction to R for plant pathologists}
\cvitemwithcomment{2018}{\href{https://reconlearn.org/post/stegen}}{Introduction to R for epidemiologists}
