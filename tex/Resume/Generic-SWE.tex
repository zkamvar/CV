...
\cvitem{}{Demonstrated experience in \textbf{developing cross-disciplinary scientific software}}
...
\cvitem{}{Developed an easy-to-use \textbf{open source lesson infrastructure} over three years}
...
\cvitem{Communication:}{\textbf{Coached >100 graduate researchers} to communicate their research to broad audiences}
...
\cvitemwithcomment{R packages:}{\href{https://carpentries.github.io/sandpaper/}{carpentries/sandpaper}}{user interface to reproducibly build and deploy data science lessons}
...
\cvitemwithcomment{Workflows:}{\href{https://github.com/carpentries/lesson-transition}{carpentries/lesson-transition}}{\textbf{automated workflow} to transform lessons to new infrastructure}
