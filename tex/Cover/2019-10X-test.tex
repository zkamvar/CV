...
I am keenly aware of the value of tests to prevent regression in behavior.
\href{https://github.com/grunwaldlab/poppr/issues/16}{One concrete example} is
from 2015 when a major version update to a dependency caused many of my tests
to fail, but my test suite allowed me to safely refactor to adapt to the
update. For the last year, as one of the technical leads on the
