...
%----------------------------------------------------------------------------------------
\cventry{2020--Present}{Lesson Infrastructure Technology Developer}{The Carpentries}{}{}{
  I develop and maintain resources for collaboration and deployment of open
  source lessons for \href{https://carpentries.org}{The Carpentries}, a global 
  community dedicated to teaching foundational skills in data analysis.
  \begin{itemize}
   \item R package \href{https://github.com/carpentries/sandpaper}{sandpaper}
         provides an infrastructure for creating, updating, and deploying lessons
   \item R package \href{https://github.com/carpentries/pegboard}{pegboard}
         extracts information from lessons and validates accessibility.
   \item \href{https://github.com/carpentries/scaffolds}{Scaffolds}
         provides links to last-minute online resources for learners who are 
         unable to install the software they are learning.
   \item \textbf{Supervisor: F. Michonneau}
  \end{itemize}
}
